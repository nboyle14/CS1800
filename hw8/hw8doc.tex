...
%%
%%
%%For each of the following subquestions (a--g) provide an answer and explanation.  No need to put subquestions on separate pages, but please don't start an answer on one page and end on another.
%%
%%Each subquestion is separate. The conditions of one subquestion do not follow through to others. 
%%
%%Although $n$ is assumed to be huge, don't use big-O notation unless specified. It is ok if your answers are off by 1.  The general ideas matter most, not lower order terms or  rounding details.
%%
%%{\bf Don't include this sentence or any of the text above in your submission.}\\
